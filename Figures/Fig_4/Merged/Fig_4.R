...
Fig_4 <- ggdraw()+
  draw_plot(Fig_4a,x = 0,y = 0.5,width = 0.333,height = 0.5)+
  draw_plot(Fig_4b,x = 0.334,y = 0.5,width = 0.333,height = 0.5)+
  draw_plot(Fig_4c,x = 0.667,y = 0.5,width = 0.333,height = 0.5)+
  draw_plot(Fig_4d,x = 0,y = 0,width = 0.333,height = 0.5)+
  draw_plot(Fig_4e,x = 0.334,y = 0,width = 0.333,height = 0.5)+
  draw_plot(Fig_4f,x = 0.667,y = 0,width = 0.333,height = 0.5)
outputFileName <- paste0(currentPath,'/Fig_4.pdf')
