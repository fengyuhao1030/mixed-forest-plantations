...
Fig_3 <- ggdraw()+
  draw_plot(Fig_3a,x = 0,y = 0.5,width = 0.333,height = 0.5)+
  draw_plot(Fig_3b,x = 0.334,y = 0.5,width = 0.333,height = 0.5)+
  draw_plot(Fig_3c,x = 0.667,y = 0.5,width = 0.333,height = 0.5)+
  draw_plot(Fig_3d,x = 0,y = 0,width = 0.333,height = 0.5)+
  draw_plot(Fig_3e,x = 0.334,y = 0,width = 0.333,height = 0.5)+
  draw_plot(Fig_3f,x = 0.667,y = 0,width = 0.333,height = 0.5)
outputFileName <- paste0(currentPath,'/Fig_3.pdf')
