...
fig_S13j <- ggplot()+
  ...
  theme_custom()
outputFileName <- paste0(currentPath,'/fig_S13j.pdf')
pdf(file = outputFileName,width = 1.55,height = 1.46,colormodel = 'cmyk')
print(fig_S13j)
dev.off()
# Insert
fig_S13j_Insert <- ggplot()+
...
outputFileName <- paste0(currentPath,'/fig_S13j_Insert.pdf')
pdf(file = outputFileName,width = 0.6,height = 0.52,colormodel = 'cmyk')
print(fig_S13j_Insert)
dev.off()
##==== Part 2: Draw ====##