...
##==== Combine figures ====##
Fig_1 <- ggdraw()+
  draw_plot(Fig_1a,x = 0,y = 0.5,width = 0.5,height = 0.5)+
  draw_plot(Fig_1b_1,x = 0.5,y = 0.5,width = 0.5,height = 0.5)+
  draw_plot(Fig_1b_2, x = 0,y = 0,width = 1,height = 0.5)
outputFileName <- paste0(currentPath,'/Fig_1.pdf')
